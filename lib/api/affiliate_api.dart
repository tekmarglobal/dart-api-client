...
class AffiliateApi {
    ...
    Future<Response<void>> apiAffiliateDetailUrllinkGet(
        ...
        final String _path = '/api/Affiliate/detail/{urllink}'.replaceAll('{' r'urllink' '}', urllink.toString());
    ...
    Future<Response<String>> apiAffiliateGetShareLinkPost({ 
        ...
        final String _path = '/api/Affiliate/GetShareLink';
        ...
        final serializedBody = _serializers.serialize(affiliateServiceLinkRequest);
        final jsonaffiliateServiceLinkRequest = json.encode(serializedBody);
    ...
    Future<Response<bool>> apiAffiliateShareLinkClickedPost({ 
        ...
        final String _path = '/api/Affiliate/ShareLinkClicked';
