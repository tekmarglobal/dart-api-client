...
class CustomerApi {
    ...
    Future<Response<RestResultOfCustomerServiceDeleteAddressResponse>> apiCustomerDeleteAddressPost({ 
        ...
        final serializedBody = _serializers.serialize(customerServiceDeleteAddressRequest);
        final jsoncustomerServiceDeleteAddressRequest = json.encode(serializedBody);
        ...
        return _dio.request(
            ...
            final serializer = _serializers.serializerForType(RestResultOfCustomerServiceDeleteAddressResponse);
            final data = _serializers.deserializeWith<RestResultOfCustomerServiceDeleteAddressResponse>(serializer, response.data is String ? jsonDecode(response.data) : response.data);
    ...
    Future<Response<RestResultOfCustomerServiceCustomerAddressResponse>> apiCustomerGetCustomerAdressesPost({ 
        ...
        return _dio.request(
            ...
            final serializer = _serializers.serializerForType(RestResultOfCustomerServiceCustomerAddressResponse);
            final data = _serializers.deserializeWith<RestResultOfCustomerServiceCustomerAddressResponse>(serializer, response.data is String ? jsonDecode(response.data) : response.data);
    ...
    Future<Response<RestResultOfCustomerServiceCustomerResponse>> apiCustomerPost({ 
        ...
        return _dio.request(
            ...
            final serializer = _serializers.serializerForType(RestResultOfCustomerServiceCustomerResponse);
            final data = _serializers.deserializeWith<RestResultOfCustomerServiceCustomerResponse>(serializer, response.data is String ? jsonDecode(response.data) : response.data);
    ...
    Future<Response<RestResultOfCustomerServiceCustomerAddressResponse>> apiCustomerUpdateAddressPost({ 
        ...
        final serializedBody = _serializers.serialize(customerServiceCustomerAddressRequest);
        final jsoncustomerServiceCustomerAddressRequest = json.encode(serializedBody);
    ...
    Future<Response<RestResultOfCustomerServiceCustomerResponse>> apiCustomerUpdateCustomerDefultAddressPost({ 
        ...
        final serializedBody = _serializers.serialize(customerServiceNewCustomerDefaultAddress);
        final jsoncustomerServiceNewCustomerDefaultAddress = json.encode(serializedBody);
    ...
    Future<Response<RestResultOfCustomerServiceCustomerResponse>> apiCustomerUpdateCustomerPost({ 
        ...
        final serializedBody = _serializers.serialize(customerServiceNewCustomerRequest);
        final jsoncustomerServiceNewCustomerRequest = json.encode(serializedBody);
