...
class CartApi {
    ...
    CartApi(this._dio, this._serializers);
        ...
        ///
        /// 
        Future<Response<bool>>apiCartGetTimeSlotTestPost({ int slotId,CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/api/Cart/GetTimeSlotTest";

        Map<String, dynamic> queryParams = {};
        Map<String, String> headerParams = Map.from(headers ?? {});
        dynamic bodyData;

                queryParams[r'slotId'] = slotId;
        queryParams.removeWhere((key, value) => value == null);
        headerParams.removeWhere((key, value) => value == null);
