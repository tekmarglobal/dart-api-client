...
class PaymentApi {
    ...
    PaymentApi(this._dio, this._serializers);
        ...
        ///
        /// 
        Future<Response<String>>apiPaymentCardResultFailPost({ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/api/Payment/CardResultFail";
        ...
        ///
        /// 
        Future<Response<String>>apiPaymentCardResultSuccessPost({ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/api/Payment/CardResultSuccess";
        ...
        List<String> contentTypes = ["application/json","text/json","application/_*+json"];
            ...
            var serializedBody = _serializers.serialize(paymentRequest);
            var jsonpaymentRequest = json.encode(serializedBody);
        ...
        var serializer = _serializers.serializerForType(PaymentResponseRestResult);
