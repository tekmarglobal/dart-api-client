...
class SanityApi {
    ...
    SanityApi(this._dio, this._serializers);
        ...
        var serializer = _serializers.serializerForType(StringListRestResult);
        var data = _serializers.deserializeWith<StringListRestResult>(serializer, response.data is String ? jsonDecode(response.data) : response.data);

            return Response<StringListRestResult>(
                data: data,
