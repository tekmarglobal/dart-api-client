...
import 'package:openapi/model/rest_result_of_system_object.dart';
    ...
    const AccountApi(this._dio, this._serializers);
        ...
        ///
        /// 
        Future<Response<RestResultOfAccountServiceVersionResponse>> apiAccountCheckversionPost({ 
            AccountServiceVersionRequest body,
            ...
            path: r'/api/Account/checkversion',
            method: 'POST',
            ...
            dynamic _bodyData;
                        ...
                        const _type = FullType(AccountServiceVersionRequest);
                        _bodyData = _serializers.serialize(body, specifiedType: _type);

            final _response = await _dio.request<dynamic>(
            r'/api/Account/checkversion',
            data: _bodyData,
            options: _request,
            cancelToken: cancelToken,
            onSendProgress: onSendProgress,
            onReceiveProgress: onReceiveProgress,
                            ...
                            const _responseType = FullType(RestResultOfAccountServiceVersionResponse);
                            final _responseData = _serializers.deserialize(
                            _response.data,
                            specifiedType: _responseType,
                            ) as RestResultOfAccountServiceVersionResponse;

                return Response<RestResultOfAccountServiceVersionResponse>(
                data: _responseData,
        ...
        Future<Response<String>> apiAccountFirebaseTokenGet({ 
            ...
            final _requestOpt = RequestOptions(
            path: r'/api/Account/FirebaseToken',
            method: 'GET',
            headers: <String, dynamic>{
            ...?headers,
            },
        ...
        Future<Response<RestResultOfAccountServiceLoginResponse>> apiAccountLoginPost({ 
            ...
            onReceiveProgress: onReceiveProgress,
                            ...
                            const _responseType = FullType(RestResultOfAccountServiceLoginResponse);
                            final _responseData = _serializers.deserialize(
                            _response.data,
                            specifiedType: _responseType,
        ...
        Future<Response<RestResultOfSystemObject>> apiAccountWhoAmIGet({ 
            ...
            onReceiveProgress: onReceiveProgress,
                            ...
                            const _responseType = FullType(RestResultOfSystemObject);
                            final _responseData = _serializers.deserialize(
                            _response.data,
                            specifiedType: _responseType,
