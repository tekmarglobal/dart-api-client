...
class _$ProductServiceRProduct extends ProductServiceRProduct {
  ...
  factory _$ProductServiceRProduct(
      ...
      (new ProductServiceRProductBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ProductServiceRProduct')
          ..add('id', id)
          ..add('name', name)
...
class ProductServiceRProductBuilder
  ...
  @override
  ProductServiceRProduct build() => _build();

  _$ProductServiceRProduct _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ProductServiceRProduct', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
