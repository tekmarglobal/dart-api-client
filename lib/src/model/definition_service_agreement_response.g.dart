...
class _$DefinitionServiceAgreementResponse
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DefinitionServiceAgreementResponse')
          ..add('id', id)
          ..add('code', code)
          ..add('content', content)
          ..add('name', name)
...
class DefinitionServiceAgreementResponseBuilder
  ...
  @override
  DefinitionServiceAgreementResponse build() => _build();

  _$DefinitionServiceAgreementResponse _build() {
    final _$result = _$v ??
