...
class _$OrderServiceCheckoutRequest extends OrderServiceCheckoutRequest {
  ...
  factory _$OrderServiceCheckoutRequest(
      ...
      (new OrderServiceCheckoutRequestBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('OrderServiceCheckoutRequest')
...
class OrderServiceCheckoutRequestBuilder
  ...
  @override
  _$OrderServiceCheckoutRequest build() {
    final _$result = _$v ??
