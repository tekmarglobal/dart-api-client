...
class _$ProductServiceRProductSerializer implements PrimitiveSerializer<ProductServiceRProduct> {
  @override
  ...
  void _deserializeProperties(
    ...
    required ProductServiceRProductBuilder result,
      ...
      switch (key) {
        ...
        case r'prices':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(BuiltList, [FullType(ProductServiceRProductPrice)]),
          ) as BuiltList<ProductServiceRProductPrice>?;
          if (valueDes == null) continue;
