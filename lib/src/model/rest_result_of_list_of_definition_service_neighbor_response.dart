...
class _$RestResultOfListOfDefinitionServiceNeighborResponseSerializer implements PrimitiveSerializer<RestResultOfListOfDefinitionServiceNeighborResponse> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.data != null) {
      ...
      yield serializers.serialize(
        object.data,
        specifiedType: const FullType.nullable(BuiltList, [FullType(DefinitionServiceNeighborResponse)]),
      );
    }
  }
  ...
  void _deserializeProperties(
    ...
    required RestResultOfListOfDefinitionServiceNeighborResponseBuilder result,
      ...
      switch (key) {
        ...
        case r'data':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(BuiltList, [FullType(DefinitionServiceNeighborResponse)]),
          ) as BuiltList<DefinitionServiceNeighborResponse>?;
          if (valueDes == null) continue;
