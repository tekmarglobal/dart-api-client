...
class _$RestResultOfOrderServiceGetOrderListResponse
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'RestResultOfOrderServiceGetOrderListResponse')
          ..add('success', success)
          ..add('message', message)
          ..add('data', data))
        .toString();
...
class RestResultOfOrderServiceGetOrderListResponseBuilder
  ...
  set data(OrderServiceGetOrderListResponseBuilder? data) =>
      _$this._data = data;

  RestResultOfOrderServiceGetOrderListResponseBuilder() {
    RestResultOfOrderServiceGetOrderListResponse._defaults(this);
  }
  ...
  @override
  RestResultOfOrderServiceGetOrderListResponse build() => _build();

  _$RestResultOfOrderServiceGetOrderListResponse _build() {
