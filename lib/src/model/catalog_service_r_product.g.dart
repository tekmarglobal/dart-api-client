...
class _$CatalogServiceRProduct extends CatalogServiceRProduct {
  ...
  factory _$CatalogServiceRProduct(
      ...
      (new CatalogServiceRProductBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'CatalogServiceRProduct')
          ..add('id', id)
          ..add('name', name)
...
class CatalogServiceRProductBuilder
  ...
  @override
  CatalogServiceRProduct build() => _build();

  _$CatalogServiceRProduct _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'CatalogServiceRProduct', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
