...
class _$CartServiceRCartItemImpact extends CartServiceRCartItemImpact {
  ...
  factory _$CartServiceRCartItemImpact(
      ...
      (new CartServiceRCartItemImpactBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'CartServiceRCartItemImpact')
...
class CartServiceRCartItemImpactBuilder
  ...
  @override
  CartServiceRCartItemImpact build() => _build();

  _$CartServiceRCartItemImpact _build() {
    final _$result = _$v ??
