...
class _$AccountServiceCheckVersionRequest
  ...
  factory _$AccountServiceCheckVersionRequest(
      ...
      (new AccountServiceCheckVersionRequestBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('AccountServiceCheckVersionRequest')
...
class AccountServiceCheckVersionRequestBuilder
  ...
  @override
  _$AccountServiceCheckVersionRequest build() {
    final _$result = _$v ??
