...
class _$AdminServiceCompanyResponse extends AdminServiceCompanyResponse {
  ...
  factory _$AdminServiceCompanyResponse(
      ...
      (new AdminServiceCompanyResponseBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AdminServiceCompanyResponse')
          ..add('name', name)
          ..add('color', color)
...
class AdminServiceCompanyResponseBuilder
  ...
  @override
  AdminServiceCompanyResponse build() => _build();

  _$AdminServiceCompanyResponse _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'AdminServiceCompanyResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
