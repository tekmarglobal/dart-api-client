...
class _$DefinitionServiceDeliveryType extends DefinitionServiceDeliveryType {
  ...
  factory _$DefinitionServiceDeliveryType(
      ...
      (new DefinitionServiceDeliveryTypeBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('DefinitionServiceDeliveryType')
          ..add('name', name)
          ..add('code', code)
...
class DefinitionServiceDeliveryTypeBuilder
  ...
  @override
  _$DefinitionServiceDeliveryType build() {
    final _$result = _$v ??
