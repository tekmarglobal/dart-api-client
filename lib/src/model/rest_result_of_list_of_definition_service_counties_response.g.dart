...
class _$RestResultOfListOfDefinitionServiceCountiesResponse
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'RestResultOfListOfDefinitionServiceCountiesResponse')
          ..add('success', success)
          ..add('message', message)
          ..add('data', data))
        .toString();
...
class RestResultOfListOfDefinitionServiceCountiesResponseBuilder
  ...
  @override
  RestResultOfListOfDefinitionServiceCountiesResponse build() => _build();

  _$RestResultOfListOfDefinitionServiceCountiesResponse _build() {
