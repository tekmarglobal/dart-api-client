...
class PaymentApi {
  ...
  Future<Response<RestResultOfPaymentServicePaymentTransactionResponse>> apiPaymentCheckTransactionPost({ 
    ...
    final _path = r'/api/Payment/CheckTransaction';
  ...
  Future<Response<RestResultOfPaymentServicePaymentResponse>> apiPaymentCreatePaymentPost({ 
    ...
    final _path = r'/api/Payment/CreatePayment';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> apiPaymentCreatePaymentReturnUrlPost({ 
    ...
    final _path = r'/api/Payment/CreatePaymentReturnUrl';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfPaymentServicePaymentTypeResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfPaymentServicePaymentTypeResponse>> apiPaymentGetPaymentTypesPost({ 
    ...
    final _path = r'/api/Payment/GetPaymentTypes';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> apiPaymentPaymentFailPost({ 
    ...
    final _path = r'/api/Payment/PaymentFail';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> apiPaymentPaymentSuccessPost({ 
    ...
    final _path = r'/api/Payment/PaymentSuccess';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
