...
class OrderApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfOrderServiceCancelationResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfOrderServiceCancelationResponse>> apiOrderAcceptCancelationGet({ 
    String? cancellationRequestCode,
    int? orderId,
    ...
    final _path = r'/api/Order/AcceptCancelation';
    ...
    final _queryParameters = <String, dynamic>{
      r'cancellationRequestCode': encodeQueryParameter(_serializers, cancellationRequestCode, const FullType(String)),
    ...
    RestResultOfOrderServiceCancelationResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RestResultOfOrderServiceCancelationResponse),
    ...
    return Response<RestResultOfOrderServiceCancelationResponse>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfSystemBoolean>> apiOrderAddExtraMessageOrderPost({ 
    OrderServiceExtraOrderMessageRequest? orderServiceExtraOrderMessageRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/Order/AddExtraMessageOrder';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(OrderServiceExtraOrderMessageRequest);
      _bodyData = orderServiceExtraOrderMessageRequest == null ? null : _serializers.serialize(orderServiceExtraOrderMessageRequest, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RestResultOfSystemBoolean),
  ...
  /// Returns a [Future] containing a [Response] with a [RestResultOfOrderServiceCancelationResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfOrderServiceCancelationResponse>> apiOrderCancelationOrderPost({ 
    int? orderId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Order/CancelationOrder';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfListOfOrderServiceCheckoutItem>> apiOrderCheckoutPost({ 
    ...
    final _path = r'/api/Order/Checkout';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfOrderServiceOrderResponse>> apiOrderCreateOrderPost({ 
    ...
    final _path = r'/api/Order/CreateOrder';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfOrderServiceGetOrderListResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfOrderServiceGetOrderListResponse>> apiOrderGetOrderListPost({ 
    ...
    final _path = r'/api/Order/GetOrderList';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfOrderServiceOrderResponse>> apiOrderGetOrderPost({ 
    ...
    final _path = r'/api/Order/GetOrder';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfOrderServiceOrderResponse>> apiOrderPatchOrderPost({ 
    ...
    final _path = r'/api/Order/PatchOrder';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfOrderServiceOrderResponse>> apiOrderUpdateStatusPost({ 
    ...
    final _path = r'/api/Order/UpdateStatus';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
