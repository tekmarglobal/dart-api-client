...
class CatalogApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfCatalogServiceRCategory] as data
  ...
  Future<Response<RestResultOfCatalogServiceRCategory>> apiCatalogAllCategoriesGet({ 
    ...
    final _path = r'/api/Catalog/allCategories';
  ...
  Future<Response<RestResultOfCatalogServiceRCategory>> apiCatalogAllCategoriesRegionGet({ 
    ...
    final _path = r'/api/Catalog/allCategoriesRegion';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<int>>> apiCatalogAllCategoriesRegionProductsIDGet({ 
    int? neighborhood,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Catalog/allCategoriesRegionProductsID';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfCatalogServiceRCategory>> apiCatalogCreateCategoryPost({ 
    ...
    final _path = r'/api/Catalog/createCategory';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfCatalogServiceRCategory>> apiCatalogDeleteCategoryDelete({ 
    ...
    final _path = r'/api/Catalog/deleteCategory';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [RestResultOfCatalogServiceRCategory] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfCatalogServiceRCategory>> apiCatalogGetNeighborhoodCatalogGet({ 
    int? neighborhood,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Catalog/getNeighborhoodCatalog';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [RestResultOfCatalogServiceRCategory] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfCatalogServiceRCategory>> apiCatalogGetRegionCatalogGet({ 
    int? region,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Catalog/getRegionCatalog';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> apiCatalogImportCategoriesFromOlimposPost({ 
    ...
    final _path = r'/api/Catalog/ImportCategoriesFromOlimpos';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfCatalogServiceRCategory>> apiCatalogUpdateCategoryPut({ 
    ...
    final _path = r'/api/Catalog/updateCategory';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
