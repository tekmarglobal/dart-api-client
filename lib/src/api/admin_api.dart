...
class AdminApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfListOfAdminServiceBranchResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfListOfAdminServiceBranchResponse>> apiAdminBranchPost({ 
    ...
    final _path = r'/api/Admin/Branch';
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfListOfAdminServiceCompanyResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfListOfAdminServiceCompanyResponse>> apiAdminCompaniesPost({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/Admin/Companies';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfListOfAdminServiceTimeSlotResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfListOfAdminServiceTimeSlotResponse>> apiAdminGenerateTimeSlotsGet({ 
    int? region,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Admin/GenerateTimeSlots';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [RestResultOfListOfAdminServiceTimeSlotResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfListOfAdminServiceTimeSlotResponse>> apiAdminGenerateTimeSlotsPost({ 
    int? region,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<String>> apiAdminGetProductGet({ 
    String? erpId,
    int? productId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/Admin/GetProduct';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfListOfAdminServiceAdminNeighborResponse>> apiAdminRegionNeighborhoodPost({ 
    ...
    final _path = r'/api/Admin/RegionNeighborhood';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfSystemInt32] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfSystemInt32>> apiAdminRegionPopulationGet({ 
    int? gpsId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Admin/RegionPopulation';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (gpsId != null) r'gpsId': encodeQueryParameter(_serializers, gpsId, const FullType(int)),
    };
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfListOfAdminServiceRegionResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfListOfAdminServiceRegionResponse>> apiAdminRegionPost({ 
    int? regionId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Admin/Region';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfAdminServiceAdminNeighborResponse>> apiAdminUpdateRegionNeighborhoodPost({ 
    ...
    final _path = r'/api/Admin/UpdateRegionNeighborhood';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfAdminServiceUploadImageResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfAdminServiceUploadImageResponse>> apiAdminUploadProductImagePost({ 
    MultipartFile? file,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Admin/UploadProductImage';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
