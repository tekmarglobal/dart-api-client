...
class DefinitionApi {
  ...
  Future<Response<RestResultOfListOfDefinitionServiceAgreementResponse>> apiDefinitionAgreementGet({ 
    ...
    final _path = r'/api/Definition/Agreement';
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfListOfDefinitionServiceCitiesResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfListOfDefinitionServiceCitiesResponse>> apiDefinitionCitiesPost({ 
    ...
    final _path = r'/api/Definition/Cities';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfListOfDefinitionServiceCountiesResponse>> apiDefinitionCountiesPost({ 
    ...
    final _path = r'/api/Definition/Counties';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfListOfDefinitionServiceFaqResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfListOfDefinitionServiceFaqResponse>> apiDefinitionFaqGet({ 
    ...
    final _path = r'/api/Definition/Faq';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [RestResultOfListOfDefinitionServiceSelfPickupPoint] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfListOfDefinitionServiceSelfPickupPoint>> apiDefinitionGetSelfPickupPointsInNeighborhoodGet({ 
    int? neighborhood,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Definition/GetSelfPickupPointsInNeighborhood';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (neighborhood != null) r'neighborhood': encodeQueryParameter(_serializers, neighborhood, const FullType(int)),
    };
  ...
  Future<Response<String>> apiDefinitionHelloGet({ 
    ...
    final _path = r'/api/Definition/Hello';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfListOfDefinitionServiceNeighborResponse>> apiDefinitionNeighborhoodPost({ 
    ...
    final _path = r'/api/Definition/Neighborhood';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfDefinitionServiceUpdateAgreementLogResponse>> apiDefinitionUpdateAgreementLogPost({ 
    ...
    final _path = r'/api/Definition/UpdateAgreementLog';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfDefinitionServiceUploadCountriesResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfDefinitionServiceUploadCountriesResponse>> apiDefinitionUploadCountriesToFirebasePost({ 
    ...
    final _path = r'/api/Definition/UploadCountriesToFirebase';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
