...
class AffiliateApi {
  ...
  Future<Response<void>> apiAffiliateDetailGet({ 
    ...
    final _path = r'/api/Affiliate/detail';
    ...
    final _queryParameters = <String, dynamic>{
      if (urlLink != null) r'urlLink': encodeQueryParameter(_serializers, urlLink, const FullType(String)),
    };
  ...
  Future<Response<String>> apiAffiliateGetShareLinkPost({ 
    ...
    final _path = r'/api/Affiliate/GetShareLink';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<bool>> apiAffiliateShareLinkClickedPost({ 
    ...
    final _path = r'/api/Affiliate/ShareLinkClicked';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
