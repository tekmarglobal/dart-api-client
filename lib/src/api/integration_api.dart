...
class IntegrationApi {
  ...
  Future<Response<String>> apiIntegrationTestGet({ 
    ...
    final _path = r'/api/Integration/test';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (delaySeconds != null) r'delaySeconds': encodeQueryParameter(_serializers, delaySeconds, const FullType(int)),
    };
  ...
  Future<Response<String>> apiIntegrationUpdateProductFromOlimposGet({ 
    ...
    final _path = r'/api/Integration/UpdateProductFromOlimpos';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
