...
class CrmApi {
  ...
  Future<Response<RestResultOfCrmServiceTicketResponse>> apiCrmCreateTicketPost({ 
    ...
    final _path = r'/api/Crm/CreateTicket';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RestResultOfCrmServiceTicketResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RestResultOfCrmServiceTicketResponse),
  ...
  Future<Response<String>> apiCrmFindCustomerIVRGet({ 
    ...
    final _path = r'/api/Crm/FindCustomerIVR';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<String>> apiCrmFindOrderIVRGet({ 
    ...
    final _path = r'/api/Crm/FindOrderIVR';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
