...
class CartApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfListOfCartServiceCampaignResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfListOfCartServiceCampaignResponse>> apiCartAddCampaignByCodePost({ 
    String? campaignCode,
    ...
    final _path = r'/api/Cart/AddCampaignByCode';
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfCartServiceCampaignApplyResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfCartServiceCampaignApplyResponse>> apiCartApplyCampaignPost({ 
    ...
    final _path = r'/api/Cart/ApplyCampaign';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (campaignId != null) r'campaignId': encodeQueryParameter(_serializers, campaignId, const FullType(int)),
    };
  ...
  Future<Response<RestResultOfCartServiceCreateCartResponse>> apiCartCreateCartPost({ 
    ...
    final _path = r'/api/Cart/CreateCart';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfCartServiceCartResponse>> apiCartDeleteCardDelete({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/Cart/DeleteCard';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [RestResultOfCartServiceCartResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfCartServiceCartResponse>> apiCartDeleteCartDelete({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/Cart/DeleteCart';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfListOfCartServiceCampaignResponse>> apiCartGetCampaignsGet({ 
    ...
    final _path = r'/api/Cart/GetCampaigns';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfListOfCartServiceTimeSlotsResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfListOfCartServiceTimeSlotsResponse>> apiCartGetTimeSlotsPost({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/Cart/GetTimeSlots';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [RestResultOfCartServiceCartResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfCartServiceCartResponse>> apiCartPost({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<RestResultOfCartServiceCartResponse>> apiCartUpdateCartPost({ 
    ...
    final _path = r'/api/Cart/UpdateCart';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfCartServiceUpdateCartRegionResponse>> apiCartUpdateCartRegionPost({ 
    ...
    final _path = r'/api/Cart/UpdateCartRegion';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfCartServiceCartResponse>> apiCartUpdateTimeslotPost({ 
    ...
    final _path = r'/api/Cart/UpdateTimeslot';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
