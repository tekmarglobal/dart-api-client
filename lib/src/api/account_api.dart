...
class AccountApi {
  ...
  Future<Response<RestResultOfAccountServiceCheckVersionResponse>> apiAccountCheckversionPost({ 
    ...
    final _path = r'/api/Account/checkversion';
    ...
    RestResultOfAccountServiceCheckVersionResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RestResultOfAccountServiceCheckVersionResponse),
    ...
    return Response<RestResultOfAccountServiceCheckVersionResponse>(
      data: _responseData,
  ...
  Future<Response<String>> apiAccountFirebaseTokenGet({ 
    ...
    final _path = r'/api/Account/FirebaseToken';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RestResultOfAccountServiceLoginResponse>> apiAccountLoginPost({ 
    ...
    RestResultOfAccountServiceLoginResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RestResultOfAccountServiceLoginResponse),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RestResultOfSystemObject] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RestResultOfSystemObject>> apiAccountWhoAmIGet({ 
    ...
    final _path = r'/api/Account/WhoAmI';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RestResultOfSystemObject? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RestResultOfSystemObject),
