        ...
        if (object.prices != null) {
            result
                ...
                ..add(serializers.serialize(object.prices,
                    specifiedType: const FullType(BuiltList, [FullType(ProductServiceRProductPrice)])));
        }
        if (object.eId != null) {
            result
                ..add(r'eId')
            ...
            switch (key) {
                ...
                case r'prices':
                    result.prices.replace(serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(ProductServiceRProductPrice)])) as BuiltList<ProductServiceRProductPrice>);
                    break;
                case r'eId':
