...
abstract class KilerPermissionPolicyObjectPermissionsObject implements Built<KilerPermissionPolicyObjectPermissionsObject, KilerPermissionPolicyObjectPermissionsObjectBuilder> {
    ...
    static void _initializeBuilder(KilerPermissionPolicyObjectPermissionsObjectBuilder b) => b;

    factory KilerPermissionPolicyObjectPermissionsObject(void updates(KilerPermissionPolicyObjectPermissionsObjectBuilder b)) = _$KilerPermissionPolicyObjectPermissionsObject;
...
class _$KilerPermissionPolicyObjectPermissionsObjectSerializer implements StructuredSerializer<KilerPermissionPolicyObjectPermissionsObject> {

    @override
    final Iterable<Type> types = const [KilerPermissionPolicyObjectPermissionsObject, _$KilerPermissionPolicyObjectPermissionsObject];
    @override
    final String wireName = r'KilerPermissionPolicyObjectPermissionsObject';

    @override
    Iterable<Object> serialize(Serializers serializers, KilerPermissionPolicyObjectPermissionsObject object,
    ...
    @override
    KilerPermissionPolicyObjectPermissionsObject deserialize(Serializers serializers, Iterable<Object> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = KilerPermissionPolicyObjectPermissionsObjectBuilder();
