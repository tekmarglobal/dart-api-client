...
Serializer<RestResultOfSystemObject> _$restResultOfSystemObjectSerializer =
    new _$RestResultOfSystemObjectSerializer();

class _$RestResultOfSystemObjectSerializer
    implements StructuredSerializer<RestResultOfSystemObject> {
  @override
  final Iterable<Type> types = const [
    RestResultOfSystemObject,
    _$RestResultOfSystemObject
  ];
  @override
  final String wireName = 'RestResultOfSystemObject';

  @override
  Iterable<Object> serialize(
      Serializers serializers, RestResultOfSystemObject object,
  ...
  @override
  RestResultOfSystemObject deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new RestResultOfSystemObjectBuilder();
...
class _$RestResultOfSystemObject extends RestResultOfSystemObject {
  ...
  factory _$RestResultOfSystemObject(
      ...
      (new RestResultOfSystemObjectBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('RestResultOfSystemObject')
          ..add('success', success)
          ..add('message', message)
          ..add('data', data))
        .toString();
...
class RestResultOfSystemObjectBuilder
  ...
  @override
  _$RestResultOfSystemObject build() {
    final _$result = _$v ??
