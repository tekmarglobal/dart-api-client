...
class _$CrmServiceTicketRequest extends CrmServiceTicketRequest {
  ...
  factory _$CrmServiceTicketRequest(
      ...
      (new CrmServiceTicketRequestBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('CrmServiceTicketRequest')
...
class CrmServiceTicketRequestBuilder
  ...
  CrmServiceTicketRequestBuilder() {
    CrmServiceTicketRequest._initializeBuilder(this);
  }
  ...
  @override
  _$CrmServiceTicketRequest build() {
    final _$result = _$v ??
