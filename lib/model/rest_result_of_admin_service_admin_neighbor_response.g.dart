...
Serializer<RestResultOfAdminServiceAdminNeighborResponse>
    _$restResultOfAdminServiceAdminNeighborResponseSerializer =
    new _$RestResultOfAdminServiceAdminNeighborResponseSerializer();

class _$RestResultOfAdminServiceAdminNeighborResponseSerializer
    implements
        StructuredSerializer<RestResultOfAdminServiceAdminNeighborResponse> {
  @override
  final Iterable<Type> types = const [
    RestResultOfAdminServiceAdminNeighborResponse,
    _$RestResultOfAdminServiceAdminNeighborResponse
  ];
  @override
  final String wireName = 'RestResultOfAdminServiceAdminNeighborResponse';
  ...
  RestResultOfAdminServiceAdminNeighborResponse deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new RestResultOfAdminServiceAdminNeighborResponseBuilder();
