...
class RestResultOfCartServiceCampaignApplyResponseBuilder
  ...
  set data(CartServiceCampaignApplyResponseBuilder data) => _$this._data = data;

  RestResultOfCartServiceCampaignApplyResponseBuilder() {
    RestResultOfCartServiceCampaignApplyResponse._initializeBuilder(this);
  }
  ...
  @override
  _$RestResultOfCartServiceCampaignApplyResponse build() {
