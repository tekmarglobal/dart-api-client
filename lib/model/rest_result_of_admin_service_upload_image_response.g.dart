...
Serializer<RestResultOfAdminServiceUploadImageResponse>
    _$restResultOfAdminServiceUploadImageResponseSerializer =
    new _$RestResultOfAdminServiceUploadImageResponseSerializer();

class _$RestResultOfAdminServiceUploadImageResponseSerializer
    implements
        StructuredSerializer<RestResultOfAdminServiceUploadImageResponse> {
  @override
  final Iterable<Type> types = const [
    RestResultOfAdminServiceUploadImageResponse,
    _$RestResultOfAdminServiceUploadImageResponse
  ];
  @override
  final String wireName = 'RestResultOfAdminServiceUploadImageResponse';
  ...
  RestResultOfAdminServiceUploadImageResponse deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new RestResultOfAdminServiceUploadImageResponseBuilder();
      ...
      switch (key) {
        ...
        case 'data':
          result.data.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(AdminServiceUploadImageResponse))
