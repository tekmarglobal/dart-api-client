...
Serializer<CatalogServiceRProduct> _$catalogServiceRProductSerializer =
    new _$CatalogServiceRProductSerializer();

class _$CatalogServiceRProductSerializer
    implements StructuredSerializer<CatalogServiceRProduct> {
  @override
  final Iterable<Type> types = const [
    CatalogServiceRProduct,
    _$CatalogServiceRProduct
  ];
  @override
  final String wireName = 'CatalogServiceRProduct';

  @override
  Iterable<Object> serialize(
      Serializers serializers, CatalogServiceRProduct object,
      ...
      result
        ...
        ..add(serializers.serialize(object.prices,
            specifiedType: const FullType(BuiltList,
                const [const FullType(CatalogServiceRProductPrice)])));
    }
    if (object.eId != null) {
      result
        ..add('eId')
  ...
  CatalogServiceRProduct deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new CatalogServiceRProductBuilder();
        ...
        case 'prices':
          result.prices.replace(serializers.deserialize(value,
              specifiedType: const FullType(BuiltList, const [
                const FullType(CatalogServiceRProductPrice)
              ])) as BuiltList<Object>);
          break;
        case 'eId':
