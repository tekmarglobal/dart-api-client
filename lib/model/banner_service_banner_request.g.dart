...
Serializer<BannerServiceBannerRequest> _$bannerServiceBannerRequestSerializer =
    new _$BannerServiceBannerRequestSerializer();

class _$BannerServiceBannerRequestSerializer
    implements StructuredSerializer<BannerServiceBannerRequest> {
  @override
  final Iterable<Type> types = const [
    BannerServiceBannerRequest,
    _$BannerServiceBannerRequest
  ];
  @override
  final String wireName = 'BannerServiceBannerRequest';

  @override
  Iterable<Object> serialize(
      Serializers serializers, BannerServiceBannerRequest object,
  ...
  BannerServiceBannerRequest deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new BannerServiceBannerRequestBuilder();
...
class _$BannerServiceBannerRequest extends BannerServiceBannerRequest {
  ...
  factory _$BannerServiceBannerRequest(
      ...
      (new BannerServiceBannerRequestBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('BannerServiceBannerRequest')
          ..add('name', name)
          ..add('active', active)
          ..add('image', image)
          ..add('index', index)
...
class BannerServiceBannerRequestBuilder
  ...
  @override
  _$BannerServiceBannerRequest build() {
    final _$result = _$v ??
