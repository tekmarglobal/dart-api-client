...
Serializer<RestResultOfAccountServiceLoginResponse>
    _$restResultOfAccountServiceLoginResponseSerializer =
    new _$RestResultOfAccountServiceLoginResponseSerializer();

class _$RestResultOfAccountServiceLoginResponseSerializer
    implements StructuredSerializer<RestResultOfAccountServiceLoginResponse> {
  @override
  final Iterable<Type> types = const [
    RestResultOfAccountServiceLoginResponse,
    _$RestResultOfAccountServiceLoginResponse
  ];
  @override
  final String wireName = 'RestResultOfAccountServiceLoginResponse';

  @override
  Iterable<Object> serialize(
      Serializers serializers, RestResultOfAccountServiceLoginResponse object,
  ...
  RestResultOfAccountServiceLoginResponse deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new RestResultOfAccountServiceLoginResponseBuilder();
