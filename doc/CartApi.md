...
[**apiCartUpdateCartNotePost**](CartApi.md#apiCartUpdateCartNotePost) | **post** /api/Cart/UpdateCartNote | 
...
# **apiCartUpdateCartNotePost**
> CartResponseRestResult apiCartUpdateCartNotePost(updateCartNoteRequest)
...
var api_instance = new CartApi();
var updateCartNoteRequest = new UpdateCartNoteRequest(); // UpdateCartNoteRequest | 

try { 
    var result = api_instance.apiCartUpdateCartNotePost(updateCartNoteRequest);
    print(result);
} catch (e) {
    print("Exception when calling CartApi->apiCartUpdateCartNotePost: $e\n");
}
```
...
------------- | ------------- | ------------- | -------------
 **updateCartNoteRequest** | [**UpdateCartNoteRequest**](UpdateCartNoteRequest.md)|  | [optional] 
