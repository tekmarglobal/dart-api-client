...
[**apiCartGetTimeSlotTestPost**](CartApi.md#apiCartGetTimeSlotTestPost) | **post** /api/Cart/GetTimeSlotTest | 
...
# **apiCartGetTimeSlotTestPost**
> bool apiCartGetTimeSlotTestPost(slotId)
...
try { 
    var result = api_instance.apiCartGetTimeSlotTestPost(slotId);
    print(result);
} catch (e) {
    print("Exception when calling CartApi->apiCartGetTimeSlotTestPost: $e\n");
}
```
...
------------- | ------------- | ------------- | -------------
 **slotId** | **int**|  | [optional] [default to null]
