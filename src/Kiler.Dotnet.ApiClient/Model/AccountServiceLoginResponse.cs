...
namespace Kiler.Dotnet.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountServiceLoginResponse")]
    public partial class AccountServiceLoginResponse : IEquatable<AccountServiceLoginResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountServiceLoginResponse" /> class.
        /// </summary>
        ...
        public AccountServiceVersionResponse VersionResponse { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountServiceLoginResponse {\n");
        ...
        {
            return this.Equals(input as AccountServiceLoginResponse);
        }

        /// <summary>
        /// Returns true if AccountServiceLoginResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountServiceLoginResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountServiceLoginResponse input)
        {
            if (input == null)
            {
                return false;
