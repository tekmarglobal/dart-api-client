...
namespace Kiler.Dotnet.ApiClient.Model
{
    ...
    public partial class DefinitionServiceSelfPickupPoint : IEquatable<DefinitionServiceSelfPickupPoint>, IValidatableObject
    {
        ...
        public DefinitionServiceSelfPickupPoint(string name = default(string), double latitude = default(double), double longitude = default(double), int regionId = default(int))
        {
            this.Name = name;
