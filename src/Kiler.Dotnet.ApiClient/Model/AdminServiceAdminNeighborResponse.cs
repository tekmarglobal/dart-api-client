...
namespace Kiler.Dotnet.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AdminServiceAdminNeighborResponse")]
    public partial class AdminServiceAdminNeighborResponse : IEquatable<AdminServiceAdminNeighborResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdminServiceAdminNeighborResponse" /> class.
        /// </summary>
        ...
        public AdminServiceAdminNeighborResponse(int id = default(int), string name = default(string), string cityName = default(string), string countyName = default(string), int region = default(int), string regionName = default(string), int gpsId = default(int), List<AdminServiceBranchResponse> branch = default(List<AdminServiceBranchResponse>))
        {
            this.Id = id;
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdminServiceAdminNeighborResponse {\n");
        ...
        {
            return this.Equals(input as AdminServiceAdminNeighborResponse);
        }

        /// <summary>
        /// Returns true if AdminServiceAdminNeighborResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AdminServiceAdminNeighborResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdminServiceAdminNeighborResponse input)
        {
            if (input == null)
            {
                return false;
