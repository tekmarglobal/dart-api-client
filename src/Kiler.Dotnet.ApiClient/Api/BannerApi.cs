...
namespace Kiler.Dotnet.ApiClient.Api
{
    ...
    /// </summary>
    public interface IBannerApiSync : IApiAccessor
    {
        ...
        ApiResponse<RestResultOfBannerServiceBannerResponse> ApiBannerGetBannersPostWithHttpInfo();
        /// <summary>
        /// 
        /// </summary>
        /// <exception cref="Kiler.Dotnet.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBannerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<RestResultOfBannerServiceBannerResponse> ApiBannerGetBannersPostAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<RestResultOfBannerServiceBannerResponse>> ApiBannerGetBannersPostWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBannerApi : IBannerApiSync, IBannerApiAsync
    {
    ...
    public partial class BannerApi : IBannerApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public BannerApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public BannerApi(Kiler.Dotnet.ApiClient.Client.Configuration configuration)
        {
        ...
        public BannerApi(Kiler.Dotnet.ApiClient.Client.ISynchronousClient client, Kiler.Dotnet.ApiClient.Client.IAsynchronousClient asyncClient, Kiler.Dotnet.ApiClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <exception cref="Kiler.Dotnet.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>RestResultOfBannerServiceBannerResponse</returns>
        public RestResultOfBannerServiceBannerResponse ApiBannerGetBannersPost()
        {
            Kiler.Dotnet.ApiClient.Client.ApiResponse<RestResultOfBannerServiceBannerResponse> localVarResponse = ApiBannerGetBannersPostWithHttpInfo();
        ...
        /// <exception cref="Kiler.Dotnet.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of RestResultOfBannerServiceBannerResponse</returns>
        public Kiler.Dotnet.ApiClient.Client.ApiResponse<RestResultOfBannerServiceBannerResponse> ApiBannerGetBannersPostWithHttpInfo()
        {
            ...
            var localVarResponse = this.Client.Post<RestResultOfBannerServiceBannerResponse>("/api/Banner/GetBanners", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiBannerGetBannersPost", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RestResultOfBannerServiceBannerResponse</returns>
        public async System.Threading.Tasks.Task<RestResultOfBannerServiceBannerResponse> ApiBannerGetBannersPostAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Kiler.Dotnet.ApiClient.Client.ApiResponse<RestResultOfBannerServiceBannerResponse> localVarResponse = await ApiBannerGetBannersPostWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RestResultOfBannerServiceBannerResponse)</returns>
        public async System.Threading.Tasks.Task<Kiler.Dotnet.ApiClient.Client.ApiResponse<RestResultOfBannerServiceBannerResponse>> ApiBannerGetBannersPostWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<RestResultOfBannerServiceBannerResponse>("/api/Banner/GetBanners", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Kiler.Dotnet.ApiClient.Client.ApiResponse<RestResultOfBannerServiceBannerResponse> ApiBannerUpdateBannerPostWithHttpInfo(BannerServiceBannerRequest bannerServiceBannerRequest = default(BannerServiceBannerRequest))
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<RestResultOfBannerServiceBannerResponse>("/api/Banner/UpdateBanner", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiBannerUpdateBannerPost", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public async System.Threading.Tasks.Task<Kiler.Dotnet.ApiClient.Client.ApiResponse<RestResultOfBannerServiceBannerResponse>> ApiBannerUpdateBannerPostWithHttpInfoAsync(BannerServiceBannerRequest bannerServiceBannerRequest = default(BannerServiceBannerRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<RestResultOfBannerServiceBannerResponse>("/api/Banner/UpdateBanner", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
