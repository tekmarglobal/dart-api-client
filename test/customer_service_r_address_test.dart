...
void main() {
  final instance = CustomerServiceRAddressBuilder();
  ...
  group(CustomerServiceRAddress, () {
    ...
    // int neighborhoodId
    test('to test the property `neighborhoodId`', () async {
      // TODO
    });

    // String neighborhoodName
    test('to test the property `neighborhoodName`', () async {
      // TODO
    });
    ...
    // int countyId
    test('to test the property `countyId`', () async {
      // TODO
    });
