...
void main() {
  ...
  group(KilerProduct, () {
    ...
    // KilerSupplier supplierNavigation
    test('to test the property `supplierNavigation`', () async {
      // TODO
    });

    // BuiltList<KilerCategoryProduct> categoryProduct
    test('to test the property `categoryProduct`', () async {
      // TODO
    });

    // BuiltList<KilerConfiguration> configurationBagProductNavigation
    test('to test the property `configurationBagProductNavigation`', () async {
      // TODO
    });

    // BuiltList<KilerConfiguration> configurationDeliveryProductNavigation
    ...
    // BuiltList<KilerRegionProduct> regionProduct
